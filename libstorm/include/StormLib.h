...
//
    ...
    #ifdef _DLL                               
      #pragma comment(lib, "libstorm.lib")   // Debug Ansi Dynamic version
    #else        
      #pragma comment(lib, "libstorm.lib")   // Debug Ansi Static version
    #endif
  #else                                         // RELEASE VERSIONS
    #ifdef _DLL
      #pragma comment(lib, "libstorm.lib")   // Release Ansi Dynamic version
    #else        
      #pragma comment(lib, "libstorm.lib")   // Release Ansi Static version
    #endif
  #endif
#endif
